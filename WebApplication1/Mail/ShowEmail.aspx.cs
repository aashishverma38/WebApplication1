...
namespace WebApplication1.Mail
{
    public partial class ShowEmail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Update Read bit where Email ID = currEmail
            dbHandler.changeReadBit(Session["currEmail"].ToString());
        ...
        {
            Response.Redirect("~/Mail/InBox.aspx");
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            DatabaseHandler dbHandler = new DatabaseHandler();
            dbHandler.changeReceiverBit(Session["currEmail"].ToString());
